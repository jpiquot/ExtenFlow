...
namespace ExtenFlow.IdentityServer.Domain.Commands
{
    ...
    public class RemoveClientClaim : ClientCommand
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveClientClaim"/> class.
        /// </summary>
        /// <remarks>This constructor must not be used. It has been added for serializers</remarks>
        [Obsolete("Can only be used by serializers")]
        public RemoveClientClaim()
        {
        ...
        public RemoveClientClaim(string aggregateId, string claimType, string? claimValue, string userId, string concurrencyCheckStamp, string? correlationId = null, string? id = null, DateTimeOffset? dateTime = null)
