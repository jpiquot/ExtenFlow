...
namespace ExtenFlow.Identity.Users.Events
{
    ...
    public class UserClaimAdded : UserEvent
    {
        ...
        public UserClaimAdded(string aggregateId, string claimType, string claimValue, string userId, Guid? correlationId = null, Guid? id = null, DateTimeOffset? dateTime = null)
