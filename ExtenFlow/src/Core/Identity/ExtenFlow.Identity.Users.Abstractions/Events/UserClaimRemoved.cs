...
namespace ExtenFlow.Identity.Users.Events
{
    ...
    public class UserClaimRemoved : UserEvent
    {
        ...
        public UserClaimRemoved(string aggregateId, string claimType, string claimValue, string userId, Guid? correlationId = null, Guid? id = null, DateTimeOffset? dateTime = null)
