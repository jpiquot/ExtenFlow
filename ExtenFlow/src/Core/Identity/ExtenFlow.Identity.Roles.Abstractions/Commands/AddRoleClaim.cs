...
namespace ExtenFlow.Identity.Roles.Commands
{
    ...
    public class AddRoleClaim : RoleCommand
    {
        ...
        public AddRoleClaim(string aggregateId, string claimType, string? claimValue, string userId, Guid? correlationId = null, Guid? id = null, DateTimeOffset? dateTime = null)
