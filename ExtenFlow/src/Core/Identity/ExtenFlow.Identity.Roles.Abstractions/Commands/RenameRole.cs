...
namespace ExtenFlow.Identity.Roles.Commands
{
    ...
    public class RenameRole : RoleCommand
    {
        ...
        public RenameRole(string aggregateId, string name, string normalizedName, string userId, string concurrencyCheckStamp, string? correlationId = null, string? id = null, DateTimeOffset? dateTime = null)
