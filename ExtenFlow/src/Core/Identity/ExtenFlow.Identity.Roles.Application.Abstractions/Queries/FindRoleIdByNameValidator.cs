...
{
    /// <summary>
    /// Class FindRoleIdByNameValidator. Implements the <see cref="ExtenFlow.Identity.Roles.Application.Queries.RoleQueryValidator{T}"/>
    /// </summary>
    /// <seealso cref="ExtenFlow.Identity.Roles.Application.Queries.RoleQueryValidator{T}"/>
