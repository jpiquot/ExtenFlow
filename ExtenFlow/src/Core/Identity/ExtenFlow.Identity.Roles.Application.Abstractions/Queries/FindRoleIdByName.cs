...
{
    /// <summary>
    /// Class FindRoleIdByName. Implements the <see cref="ExtenFlow.Identity.Roles.Application.Queries.RoleNameRegistryQuery{T}"/>
    /// </summary>
    /// <seealso cref="ExtenFlow.Identity.Roles.Application.Queries.RoleNameRegistryQuery{T}"/>
