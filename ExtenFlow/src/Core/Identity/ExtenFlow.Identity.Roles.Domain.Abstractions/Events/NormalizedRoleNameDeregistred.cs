...
{
    /// <summary>
    /// Class NormalizedRoleNameUnregistred. Implements the <see cref="ExtenFlow.Identity.Roles.Domain.Events.RoleEvent"/>
    /// </summary>
    /// <seealso cref="ExtenFlow.Identity.Roles.Domain.Events.RoleEvent"/>
