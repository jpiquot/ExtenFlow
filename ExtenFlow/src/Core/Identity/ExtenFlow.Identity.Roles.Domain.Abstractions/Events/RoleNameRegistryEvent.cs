...
namespace ExtenFlow.Identity.Roles.Domain.Events
{
    ...
    /// </summary>
    /// <seealso cref="Event"/>
    public abstract class RoleNameRegistryEvent : Event
    {
        /// <summary>
        ...
        protected RoleNameRegistryEvent()
        {
        ...
        protected RoleNameRegistryEvent(string aggregateId, string userId, string? correlationId = null, string? id = null, DateTimeOffset? dateTime = null)
