...
namespace ExtenFlow.Domain
{
    ...
    public abstract class Request : Message, IRequest
    {
        ...
        protected Request(string aggregateType, string? aggregateId, string userId, Guid correlationId, Guid id, DateTimeOffset dateTime) : base(aggregateType, aggregateId, userId, correlationId, id, dateTime)
        {
        }
    }
}