...
{
    /// <summary>
    /// Class UserConcurrencyFailureException. Implements the <see cref="System.Exception"/>
    /// </summary>
    /// <seealso cref="System.Exception"/>
    public class UserConcurrencyFailureException : Exception
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserConcurrencyFailureException"/> class.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        public UserConcurrencyFailureException(string message) : base(message)
        {
        }
        ...
        /// </param>
        public UserConcurrencyFailureException(string message, Exception innerException) : base(message, innerException)
        {
        }
        ...
        /// Actual stamp : '{1}'.
        /// </remarks>
        public UserConcurrencyFailureException(CultureInfo culture, string? expected, string? actual, Exception? innerException = null)
            : base(string.Format(culture, Properties.Resources.UserConcurrencyFailure, expected, actual), innerException)
        {
        }
        ...
        /// Initializes a new instance of the <see cref="UserConcurrencyFailureException"/> class.
        /// </summary>
        public UserConcurrencyFailureException()
        {
        }
    }
}