...
namespace ExtenFlow.Identity.Users.Events
{
    ...
    public class NewUserRegistred : UserEvent
    {
        ...
        public NewUserRegistred(string aggregateId, string name, string normalizedName, string userId, Guid? correlationId = null, Guid? messageId = null, DateTimeOffset? dateTime = null)
