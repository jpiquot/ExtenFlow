...
{
    /// <summary>
    /// User claim added event
    /// </summary>
    /// <seealso cref="UserEvent"/>
    public class UserClaimAdded : UserEvent
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserClaimAdded"/> class.
        /// </summary>
        /// <remarks>This constructor must not be used. It has been added for serializers</remarks>
        [Obsolete("Can only be used by serializers")]
        public UserClaimAdded()
        {
        ...
        public UserClaimAdded(string aggregateId, string claimType, string claimValue, string userId, Guid? correlationId = null, Guid? messageId = null, DateTimeOffset? dateTime = null)
