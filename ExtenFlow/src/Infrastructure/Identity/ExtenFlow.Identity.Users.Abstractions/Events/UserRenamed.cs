...
namespace ExtenFlow.Identity.Users.Events
{
    ...
    public class UserRenamed : UserEvent
    {
        ...
        public UserRenamed(string aggregateId, string name, string normalizedName, string userId, Guid? correlationId = null, Guid? messageId = null, DateTimeOffset? dateTime = null)
