...
namespace ExtenFlow.Identity.Users.Commands
{
    ...
    public class AddUserClaim : UserCommand
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddUserClaim"/> class.
        /// </summary>
        ...
        public AddUserClaim(string aggregateId, string claimType, string? claimValue, string userId, Guid? correlationId = null, Guid? messageId = null, DateTimeOffset? dateTime = null)
