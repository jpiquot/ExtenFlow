...
namespace ExtenFlow.Identity.Users.Commands
{
    ...
    public class AddUserClaims : UserCommand
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddUserClaims"/> class.
        /// </summary>
        ...
        /// <param name="claims">List of claims to add as a dictionary of (Claim Type, Claim Value).</param>
        ...
        public AddUserClaims(string aggregateId, Dictionary<string, string> claims, string userId, Guid? correlationId = null, Guid? messageId = null, DateTimeOffset? dateTime = null)
