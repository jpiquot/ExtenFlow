...
namespace ExtenFlow.Identity.Users.Commands
{
    ...
    public class RenameUser : UserCommand
    {
        ...
        public RenameUser(string aggregateId, string name, string normalizedUserName, string concurrencyStamp, string userId, Guid? correlationId = null, Guid? id = null, DateTimeOffset? dateTime = null)
