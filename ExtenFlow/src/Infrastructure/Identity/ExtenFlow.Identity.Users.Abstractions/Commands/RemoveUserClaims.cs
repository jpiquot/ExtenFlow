...
namespace ExtenFlow.Identity.Users.Commands
{
    ...
    public class RemoveUserClaims : UserCommand
    {
        ...
        public RemoveUserClaims(string aggregateId, Dictionary<string, string> claims, string userId, Guid? correlationId = null, Guid? id = null, DateTimeOffset? dateTime = null)
