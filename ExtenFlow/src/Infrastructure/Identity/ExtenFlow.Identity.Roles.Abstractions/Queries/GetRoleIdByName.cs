...
// <copyright file="GetRoleIdByName.cs" company="Fiveforty">
...
namespace ExtenFlow.Identity.Roles.Queries
{
    ...
    public class GetRoleIdByName : RoleQuery<string?>
    {
        ...
        public GetRoleIdByName(string aggregateId, string userId, Guid? correlationId = null, Guid? id = null, DateTimeOffset? dateTime = null)
