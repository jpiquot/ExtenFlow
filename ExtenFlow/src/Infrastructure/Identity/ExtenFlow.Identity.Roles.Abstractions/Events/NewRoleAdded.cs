...
namespace ExtenFlow.Identity.Roles.Events
{
    ...
    public class NewRoleAdded : RoleEvent
    {
        ...
        public NewRoleAdded(string aggregateId, string name, string normalizedName, string userId, Guid? correlationId = null, Guid? messageId = null, DateTimeOffset? dateTime = null)
