...
namespace ExtenFlow.Identity.Roles.Commands
{
    ...
    public class RemoveRoleClaim : RoleCommand
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveRoleClaim"/> class.
        /// </summary>
        /// <remarks>This constructor must not be used. It has been added for serializers</remarks>
        [Obsolete("Can only be used by serializers")]
        public RemoveRoleClaim()
        {
        ...
        public RemoveRoleClaim(string aggregateId, string claimType, string? claimValue, string concurrencyStamp, string userId, Guid? correlationId = null, Guid? messageId = null, DateTimeOffset? dateTime = null)
