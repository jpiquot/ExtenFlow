...
namespace ExtenFlow.Identity.Roles.Commands
{
    ...
    public class RemoveRoleClaim : RoleCommand
    {
        ...
        public RemoveRoleClaim(string aggregateId, string claimType, string? claimValue, string userId, Guid? correlationId = null, Guid? messageId = null, DateTimeOffset? dateTime = null)
