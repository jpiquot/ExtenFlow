...
namespace ExtenFlow.Messages.AbstractionsTests
{
    ...
    {
        protected override TestEvent Create(string aggregateType, string aggregateId, string userId, Guid correlationId, Guid messageId, DateTimeOffset dateTime)
           => new TestEvent(aggregateType, aggregateId, userId, correlationId, messageId, dateTime);
